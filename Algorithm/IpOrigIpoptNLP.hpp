...
public:
   ...
   // zhangduo added
   virtual bool InitializeHomotopyParameters(
   ...
   // zhangduo added
   // Accessor method for homotopy
   virtual SmartPtr<const Vector> t_Ori() const
   {
      return t_Ori_;
   }

   virtual SmartPtr<const Vector> t_Dest() const
   {
      return t_Dest_;
   }

   virtual SmartPtr<const Matrix> P_homo() const
   {
      return P_homo_;
   }
   // zhangduo added ends
...
private:
   ...
   // zhangduo added
   SmartPtr<const MatrixSpace> p_homo_space_;
   SmartPtr<const VectorSpace> t_ori_space_;
   SmartPtr<const VectorSpace> t_dest_space_;
   SmartPtr<const VectorSpace> curr_t_dest_space_;
   // zhangduo added ends
   ...
   // zhangduo added
   /** homotopy origin */
   SmartPtr<const Vector> t_Ori_;

   /** homotopy destination */
   SmartPtr<const Vector> t_Dest_;

   /** Permutation matrix (x -> t) */
   SmartPtr<const Matrix> P_homo_;
   // zhangduo added ends
   ///@}
